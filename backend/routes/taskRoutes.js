...
router.post('/:id/completions/:completionId/approve', protect, admin, taskController.approveCompletion);
router.post('/:id/completions/:completionId/reject', protect, admin, taskController.rejectCompletion);
